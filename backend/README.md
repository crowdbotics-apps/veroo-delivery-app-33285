...
## Project Structure
    ...
    ├── veroo_delivery_app_33285  # Django project configurations
...
1. Clone this repo and `cd veroo_delivery_app_33285`
...
2. Clone this repo and `cd veroo_delivery_app_33285`
